...
namespace QuanLyNhanVien
{
    public partial class UserControlBangLuong : UserControl
    {
        ...
        private void themLuong_Click(object sender, EventArgs e)
        {
            ...
            //    (ID_NhanVien, LuongCoBan, PhuCap, GhiChu)
            //    VALUES (@ID_NhanVien, @LuongCoBan, @PhuCap, @GhiChu)";
            //ThucHien = new SqlCommand(Lenh, KetNoi);
        ...
        private void BangLuongForm_Click(object sender, EventArgs e)
        {

        }

        private void UserControlBangLuong_Load_1(object sender, EventArgs e)
        {
            //LoadNhanVien();
            //KetNoi = new SqlConnection(Nguon);
            ////HienThi();
